...
/*
 ...
 このあたりはムーブセマンティクスの回が来たら詳しく扱う予定です。
*/
...
// 良くない例。vecのコピーを作っているので、コピーのコストがかかるし、メモリも無駄に使ってしまいます。
...
// 良い例。vecへの参照を受け取っているので、コピーのコストがかからないし、メモリの無駄遣いもしていません。
...
// 参照型を返す関数も定義できます。x==0ならvec1、そうでなければvec2を返しています。
// ただし、返す変数が関数を抜けた後もきちんと生存しているかどうか注意してください。
